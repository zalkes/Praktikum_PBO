...
public class IbuHamil {
    ...
    protected int idIbuHamil, usiaKehamilan;
    protected String nama, tglLahir, alamat, noTelp, riwayatKesehatan;
    ...
    public String toString() {
        return String.format("%-10s | %-15s | %-13s | %-18s | %-18s | %-7s Minggu | %-15s", idIbuHamil, nama, tglLahir, alamat, noTelp, usiaKehamilan, riwayatKesehatan);
    }
}
