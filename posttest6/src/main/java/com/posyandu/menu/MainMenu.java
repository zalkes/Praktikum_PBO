...
//Penggunaan access modifier public dan final di class
public final class MainMenu {
    ...
    // Penggunaan final di method
    private final void balitaMenu() {
        int pilihan;
        do {
            clearScreen();
            System.out.println("=================================");
    ...
    //Penggunaan static di variabel
    static int jumlahBalita = 0;
